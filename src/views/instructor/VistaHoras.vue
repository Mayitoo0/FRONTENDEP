...
const obtenerDatos = async () => {
  try {
    ...
    console.error('Error al cargar resumen de horas:', error)
  }
}
...
const onVisualizar = (row) => console.log('Visualizar:', row)
const onDescargar = (row) => console.log('Descargar:', row)
const onEliminar = (row) => console.log('Eliminar:', row)
</script>
