...
function cargarInstructoresPorArea() {
  if (areaConocimiento.value) {
    instructoresDisponibles.value = todosLosInstructores.value.filter(
      instructor => instructor.area === areaConocimiento.value
    )
  } else {
...
async function confirmarAceptacion() {
  try {
    console.log('Aceptando documentos:', {
      aprendiz: nombreAprendiz.value,
...
async function confirmarRechazo() {
  try {
    console.log('Rechazando documentos:', {
      aprendiz: nombreAprendiz.value,
